...
concrete TestLexiconGer of TestLexiconGerAbs = 
  LexiconGer, ExtraGer[NS,NV,NQ,V4,CorAdv,VSA] **
...
lin
  ...
  -- Adv construction by correlate+subjunctor+S
  deshalb_weil_Subj  = mkSubj "deshalb" "weil" ;
  so_wie_Subj        = mkSubj "so"      "wie" ;
  dorthin_wohin_Subj = mkSubj "dorthin" "wohin" ;
  dorther_woher_Subj = mkSubj "dorther" "woher" ;
  solange_bis_Subj   = mkSubj "solange" "bis" ;
}
