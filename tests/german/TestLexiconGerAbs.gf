...
fun
  ...
  -- CorAdv: relation to relate adverbial correlate and subjunctor

  -- dort_wo_Subj : Subj ; -- in ExtraGerAbs
  deshalb_weil_Subj : Subj ;
  so_wie_Subj : Subj ;
  dorthin_wohin_Subj : Subj ;
  dorther_woher_Subj : Subj ;
  solange_bis_Subj : Subj ;
